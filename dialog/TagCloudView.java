...
public class TagCloudView extends ViewGroup {
    ...
    private static final int DEFAULT_TEXT_BACKGROUND = R.drawable.tag_background;//默认背景样式
    ...
    private static final int DEFAULT_TAG_RESID = R.layout.item_tag_style; //默认标签布局
    private static final int DEFAULT_RIGHT_IMAGE = R.drawable.ic_more;//tag的右图标
...
//        Log.e("times", "---height=" + heightCount);
    ...
    public void setLineCountLimit(int countLimit) {
        this.lineCountLimit = countLimit;
    }
    ...
    public void singleLine(boolean mSingleLine, int maxHeight) {
